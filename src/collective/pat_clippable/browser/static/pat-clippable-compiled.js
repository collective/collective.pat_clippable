...
require([
  ...
  var Clippable = Base.extend({
    ...
    createButton: function(index, html) {
      var that = this
...
define("/usr/local/plone-5.2/zeoserver/src/collective.pat_clippable/src/collective/pat_clippable/browser/static/pat-clippable.js", function(){});
